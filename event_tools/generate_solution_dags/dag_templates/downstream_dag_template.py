...
@dag(
    dag_display_name="Solution DOWNSTREAM_DAG_ID_TO_REPLACE 📒",
    ...
    tags=["solution", "SET_NUMBER"],
)
def DOWNSTREAM_DAG_ID_TO_REPLACE():

    @task
    def fetch_cities_weather_table(**context) -> pd.DataFrame:

        df = context["ti"].xcom_pull(
            dag_id="UPSTREAM_DAG_ID_1_TO_REPLACE",
    ...
    def fetch_max_temp_data(**context) -> dict:
        ...
        data = context["ti"].xcom_pull(
            dag_id="UPSTREAM_DAG_ID_2_TO_REPLACE",
