"""
Exercise 6: Add setup/teardown designations to tasks in this DAG so that CSV files
are cleaned up even if faulty data is provided.
"""
...
@dag(
    ...
    tags=["exercise_5", "setup/teardown"],
)
def exercise_5_setup_teardown():
